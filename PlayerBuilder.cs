...
public class PlayerBuilder : MonoBehaviour
{
	...
	{
		int num = bulletTable.n_USE_DEFAULT_WEAPON switch
		{
			-1 => -1, 
			0 => ManagedSingleton<OrangeDataManager>.Instance.CHARACTER_TABLE_DICT[SetPBP.CharacterID].n_INIT_WEAPON1, 
			_ => ManagedSingleton<OrangeDataManager>.Instance.CHARACTER_TABLE_DICT[SetPBP.CharacterID].n_INIT_WEAPON2, 
		};
		if (num != -1)
		{
	...
	private IEnumerator Build(CallbackObjs pCallBack)
	{
		...
		playerInstance.SetActive(value: false);
		...
		Transform[] target = playerInstance.transform.GetComponentsInChildren<Transform>(includeInactive: true);
		...
		{
			gameObject6.transform.SetParent(transform, worldPositionStays: false);
			gameObject7.transform.SetParent(transform, worldPositionStays: false);
			gameObject8.transform.SetParent(transform, worldPositionStays: false);
			gameObject9.transform.SetParent(transform, worldPositionStays: false);
			gameObject10.transform.SetParent(transform, worldPositionStays: false);
			gameObject11.transform.SetParent(transform, worldPositionStays: false);
			gameObject12.transform.SetParent(transform, worldPositionStays: false);
			gameObject13.transform.SetParent(transform, worldPositionStays: false);
		}
		else
		{
			...
			gameObject8.transform.SetParent(parent, worldPositionStays: false);
			gameObject9.transform.SetParent(parent, worldPositionStays: false);
			gameObject10.transform.SetParent(parent, worldPositionStays: false);
			gameObject11.transform.SetParent(parent, worldPositionStays: false);
			gameObject12.transform.SetParent(parent, worldPositionStays: false);
			gameObject13.transform.SetParent(parent, worldPositionStays: false);
		}
		Transform parent2 = OrangeBattleUtility.FindChildRecursive(ref target, "Footsteps");
		gameObject2.transform.SetParent(parent2, worldPositionStays: false);
		...
		gameObject4.transform.SetParent(parent3, worldPositionStays: false);
		Transform parent4 = OrangeBattleUtility.FindChildRecursive(ref target, "R_Thruster");
		gameObject5.transform.SetParent(parent4, worldPositionStays: false);
		InstantiateWeapons(DefaultWeaponList, ref target, isSkill: true, characterTableExtraSize[0]);
		InstantiateWeapons(SetPBP.WeaponList, ref target, isSkill: false, characterTableExtraSize[0]);
		...
		if (SetPBP.tRefPassiveskill == null)
		{
			...
			if (ManagedSingleton<PlayerNetManager>.Instance.dicWeapon.TryGetValue(SetPBP.WeaponList[0], out value))
			{
				...
				{
					SetPBP.tRefPassiveskill.AddPassivesSkill(value2.netChipInfo, 4, 1, bCheckUse: true);
					if (!SetPBP.tRefPassiveskill.tMainPassiveskillStatus.tSKILL_TABLE.s_USE_MOTION.Equals("null"))
					{
						MonoBehaviourSingleton<AssetsBundleManager>.Instance.GetAssetAndAsyncLoad("prefab/fx/chipeffect/" + SetPBP.tRefPassiveskill.tMainPassiveskillStatus.tSKILL_TABLE.s_USE_MOTION, SetPBP.tRefPassiveskill.tMainPassiveskillStatus.tSKILL_TABLE.s_USE_MOTION, delegate(GameObject obj)
						{
							...
							player.PlayerWeapons[0].ChipEfx.transform.SetParent(parent8, worldPositionStays: false);
			...
			if (ManagedSingleton<PlayerNetManager>.Instance.dicWeapon.TryGetValue(SetPBP.WeaponList[1], out value))
			{
				...
				{
					SetPBP.tRefPassiveskill.AddPassivesSkill(value3.netChipInfo, 8, 1, bCheckUse: true);
					if (!SetPBP.tRefPassiveskill.tSubPassiveskillStatus.tSKILL_TABLE.s_USE_MOTION.Equals("null"))
					{
						MonoBehaviourSingleton<AssetsBundleManager>.Instance.GetAssetAndAsyncLoad("prefab/fx/chipeffect/" + SetPBP.tRefPassiveskill.tSubPassiveskillStatus.tSKILL_TABLE.s_USE_MOTION, SetPBP.tRefPassiveskill.tSubPassiveskillStatus.tSKILL_TABLE.s_USE_MOTION, delegate(GameObject obj)
						{
							...
							player.PlayerWeapons[1].ChipEfx.transform.SetParent(parent7, worldPositionStays: false);
		...
		else
		{
			if (SetPBP.tRefPassiveskill.tMainPassiveskillStatus != null && !SetPBP.tRefPassiveskill.tMainPassiveskillStatus.tSKILL_TABLE.s_USE_MOTION.Equals("null"))
			{
				MonoBehaviourSingleton<AssetsBundleManager>.Instance.GetAssetAndAsyncLoad("prefab/fx/chipeffect/" + SetPBP.tRefPassiveskill.tMainPassiveskillStatus.tSKILL_TABLE.s_USE_MOTION, SetPBP.tRefPassiveskill.tMainPassiveskillStatus.tSKILL_TABLE.s_USE_MOTION, delegate(GameObject obj)
				{
					...
					player.PlayerWeapons[0].ChipEfx.transform.SetParent(parent6, worldPositionStays: false);
					player.PlayerWeapons[0].chip_switch = true;
					if (SetPBP.CharacterID == 60)
					{
						player.PlayerWeapons[0].ChipEfx.SetActivePosition(new Vector3(0f, 0.35f, 0f));
			...
			if (SetPBP.tRefPassiveskill.tSubPassiveskillStatus != null && !SetPBP.tRefPassiveskill.tSubPassiveskillStatus.tSKILL_TABLE.s_USE_MOTION.Equals("null"))
			{
				MonoBehaviourSingleton<AssetsBundleManager>.Instance.GetAssetAndAsyncLoad("prefab/fx/chipeffect/" + SetPBP.tRefPassiveskill.tSubPassiveskillStatus.tSKILL_TABLE.s_USE_MOTION, SetPBP.tRefPassiveskill.tSubPassiveskillStatus.tSKILL_TABLE.s_USE_MOTION, delegate(GameObject obj)
				{
					...
					player.PlayerWeapons[1].ChipEfx.transform.SetParent(parent5, worldPositionStays: false);
					player.PlayerWeapons[1].chip_switch = true;
					if (SetPBP.CharacterID == 60)
					{
						player.PlayerWeapons[1].ChipEfx.SetActivePosition(new Vector3(0f, 0.35f, 0f));
		...
		if (IsLocalPlayer && ManagedSingleton<OrangeDataManager>.Instance.STAGE_TABLE_DICT.TryGetValue(ManagedSingleton<StageHelper>.Instance.nLastStageID, out var value8))
		{
		...
		{
			IsLocalPlayer = false;
			OrangeBattleUtility.ChangeLayersRecursively(gameObject.transform, ManagedSingleton<OrangeLayerManager>.Instance.RenderPlayer, chageSelf: false);
		}
		if (IsLocalPlayer)
		{
		...
		Setting setting = ((!IsLocalPlayer) ? new Setting(ModelSetup: true) : MonoBehaviourSingleton<OrangePlayerLocalData>.Instance.SaveData.Setting);
		...
		if (IsLocalPlayer)
		{
			StageUpdate.SyncStageObj(3, 17, player.sPlayerID, bNoCheckHost: true, bNoCheckReConnect: true);
		}
		if (bNeedLockInput)
		{
			player.EventLockInputingNet = true;
		...
		playerInstance.SetActive(value: true);
