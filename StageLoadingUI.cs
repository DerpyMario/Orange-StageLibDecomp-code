...
public class StageLoadingUI : MonoBehaviour, ILoadingState
{
	...
	private void Start()
	{
		OrangeBgExt orangeBgExt = Object.Instantiate(bgExt, base.transform, worldPositionStays: false);
		orangeBgExt.rt.SetParent(base.transform, worldPositionStays: false);
