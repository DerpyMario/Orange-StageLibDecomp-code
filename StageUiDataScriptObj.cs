...
public class StageUiDataScriptObj : ScriptableObject
{
	...
	public void InitDefaultData()
	{
		...
		listStageUiDatas.Add(new StageUiData(4, 10002, StageUiData.STAGE_UI_ENUM.ShowGetItemUI2, 2, ibParam0: true, ibParam1: true));
		listStageUiDatas.Add(new StageUiData(4, 10012, StageUiData.STAGE_UI_ENUM.ShowGetItemUI2, 4, ibParam0: false, ibParam1: true));
		listStageUiDatas.Add(new StageUiData(4, 10015, StageUiData.STAGE_UI_ENUM.ShowGetItemUI2, 5, ibParam0: false, ibParam1: true));
		listStageUiDatas.Add(new StageUiData(4, 10016, StageUiData.STAGE_UI_ENUM.ShowGetItemUI2, 6, ibParam0: false, ibParam1: true));
		listStageUiDatas.Add(new StageUiData(4, 10014, StageUiData.STAGE_UI_ENUM.ShowBattleScoreUI, 1, ibParam0: true));
		listStageUiDatas.Add(new StageUiData(4, 10019, StageUiData.STAGE_UI_ENUM.ShowGetItemUI2, 7, ibParam0: false, ibParam1: true));
		listStageUiDatas.Add(new StageUiData(4, 10020, StageUiData.STAGE_UI_ENUM.ShowGetItemUI2, 2, ibParam0: true));
