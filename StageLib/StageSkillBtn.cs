...
public class StageSkillBtn : MonoBehaviour
{
	...
	private void Start()
	{
		...
		RecahrgeImg.gameObject.SetActive(value: false);
		RecahrgeBg.gameObject.SetActive(value: false);
	}
	...
	private void Update()
	{
		if (fNowChangeTime > 0f)
		{
			...
			OkImg.gameObject.SetActive(value: false);
			OkBg.gameObject.SetActive(value: false);
			RecahrgeImg.gameObject.SetActive(value: true);
		...
		{
			RecahrgeImg.gameObject.SetActive(value: false);
			OkImg.gameObject.SetActive(value: true);
			OkBg.gameObject.SetActive(value: true);
