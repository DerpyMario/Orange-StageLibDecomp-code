...
public class StageHelper : ManagedSingleton<StageHelper>
{
	...
	public enum STAGE_END_GO
	{
		...
		PVPRANDOMMATCHING,
		GUIDE,
		SEASONRANDOMMATCHING,
		SEASON,
		ACTIVITYEVENT,
		WOLRDBOSS,
		CRUSADE,
		FRIENDPVPCREATEPRIVATEROOM,
		FRIENDPVPJOINPRIVATEROOM,
		TOTALWAR
	}
	...
	public static string GetLocalString(string sTableKey)
	{
		...
		{
			"LOCALIZATION_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.LOCALIZATION_TABLE_DICT.GetL10nValue(array[1]), 
			"SKILLTEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.SKILLTEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"CHARATEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.CHARATEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"WEAPONTEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.WEAPONTEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"CARDTEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.CARDTEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"SKINTEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.SKINTEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"ITEMTEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.ITEMTEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"EQUIPTEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.EQUIPTEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"DISCTEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.DISCTEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"SCENARIOTEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.SCENARIOTEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"STAGETEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.STAGETEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"MISSIONTEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.MISSIONTEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"MAILTEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.MAILTEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"HOWTOGETTEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.HOWTOGETTEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"RECORDTIP_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.RECORDTIP_TABLE_DICT.GetL10nValue(array[1]), 
			"RANDOMNAME_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.RANDOMNAME_TABLE_DICT.GetL10nValue(array[1]), 
			"TIP_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.TIP_TABLE_DICT.GetL10nValue(array[1]), 
			"WANTEDTEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.WANTEDTEXT_TABLE_DICT.GetL10nValue(array[1]), 
			"AREATEXT_TABLE" => ManagedSingleton<OrangeTextDataManager>.Instance.AREATEXT_TABLE_DICT.GetL10nValue(array[1]), 
			_ => "", 
		};
	}
	...
	{
		if (ManagedSingleton<OrangeDataManager>.Instance.STAGE_TABLE_DICT.TryGetValue(stageID, out var value))
		{
