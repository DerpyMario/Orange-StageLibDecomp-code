...
public class LockStepController : MonoBehaviour
{
	...
	public static bool LockStepPause => _lockStepPause > 0;
	...
	protected void OnEnable()
	{
		...
		MonoBehaviourSingleton<CBSocketClient>.Instance.SendProtocol(FlatBufferCBHelper.CreateRQLockStepMoveForward(oncePause: false));
	}

	protected void OnDisable()
	{
		MonoBehaviourSingleton<SignalDispatcher>.Instance.RemoveHandler(CB.NTLockStepMoveForward, OnNTLockStepMoveForward);
		MonoBehaviourSingleton<CBSocketClient>.Instance.SendProtocol(FlatBufferCBHelper.CreateRQLockStepMoveForward(oncePause: true));
